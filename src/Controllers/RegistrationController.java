...
public class RegistrationController {
	...
	public void ActionRegistration(ActionEvent event) throws SQLException {
		if(textFieldFullN.getText().isBlank() || textFieldEmail.getText().isBlank() || textFieldPhone.getText().isBlank() || textFieldUsern.getText().isBlank() || textFieldPassword.getText().isBlank()  || textFieldHint.getText().isBlank() ) {
		Alert alert = new Alert(AlertType.ERROR,"vueillez dfghjk",ButtonType.CANCEL);
		alert.showAndWait();
		}else {
